...
const getModelsByCategory = (models: any[] = []) => {
  const categories: { [key: string]: typeof models } = {}
...
export function VersionCompareView({
  ...
  // 取得分組模型
  const modelsByCategory = useMemo(() => getModelsByCategory(availableModels), [availableModels])
  ...
  }, [availableModels, modelSearchQuery, showThinkingModels]);
  ...
  return (
    <TooltipProvider>
      <div className="flex w-full">
        ...
        {/* 右側對話 view 區塊 */}
        <div className="flex-1 flex flex-col bg-black p-4 overflow-hidden">
            ...
            >
              {sortedVersions.map((version, versionIndex) => {
                ...
                return (
                  ...
                  >
                    <Card
                      className={`flex flex-col transition-all duration-200 flex-1 ${
                        colorMode === 1
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ minHeight: 'calc(100vh - 80px - 160px - 70px)', maxHeight: 'calc(100vh - 80px - 160px - 70px)' }}
                      >
                        {(() => {
