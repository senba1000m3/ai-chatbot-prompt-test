					...
					<div className="space-y-8">
						...
						<CollapsibleSection title="System Prompt" defaultOpen={true}>
							<div className="space-y-6">
								<div>
									<h4 className="font-medium mb-3 text-white text-base">角色設定</h4>
								...
								<div>
									<h4 className="font-medium mb-3 text-white text-base">自我認知</h4>
								...
								<div>
									<h4 className="font-medium mb-3 text-white text-base">任務流程</h4>
								...
								<div>
									<h4 className="font-medium mb-3 text-white text-base">格式限制</h4>
									<DetailedSystemPrompt
										title="格式限制"
								...
								<div>
									<h4 className="font-medium mb-3 text-white text-base">工具使用</h4>
									<SelectionSystemPrompt
										title="工具使用"
										value={systemPrompt.usedTools}
										onChange={(value) => setSystemPrompt((prev) => ({ ...prev, usedTools: value }))}
										options={systemPromptOptions.usedTools}
										onOptionsChange={(options) => onSystemPromptOptionsChange("usedTools", options)}
										isReadOnly={isReadOnly && !isEditing}
									/>
								</div>

								<div>
									<h4 className="font-medium mb-3 text-white text-base">回覆限制與要求</h4>
									<AdditionalSystemPrompt
										title="回覆限制與要求"
								...
								<div>
									<h4 className="font-medium mb-3 text-white text-base">防洩漏限制</h4>
									<AdditionalSystemPrompt
										title="防洩漏限制"
